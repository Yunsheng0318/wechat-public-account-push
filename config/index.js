export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx64c190dcd15921ae",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8c82f4b9b34000f92b2c6e838ea53b62",
  ...
  USERS: [
    {
      ...
      id: "osRAg5jXhl04rdcts4pG-FE97FzU",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "x_Gl6cMAgdr9P9xE0EzjNTMweCdn_DncDCVBBR6YaLk",
      // 所在省份
      province: "河北",
      // 所在城市
      city: "保定",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "小馨", "year": "2003", "date": "07-30"},
        {"type": "节日", "*name": "小岩", "year": "2004", "date": "03-18"},
